...
int dpxio_jp2_opensequence(dpxio_handle * dpxio, dpxio_fileio * pfileio, char * filename, int firstframe, int lastframe)
{
  return TRUE;
}

int dpxio_jp2_closesequence(dpxio_handle * dpxio, dpxio_fileio * pfileio)
{
  return TRUE;
}

int dpxio_jp2_readframe(dpxio_handle * dpxio, dpxio_fileio * pfileio, int framenr, sv_fifo_buffer * pbuffer, char * buffer, int buffersize, int * offset, int * xsize, int * ysize, int * dpxtype, int * nbits)
{
...
int dpxio_jp2_writeframe(dpxio_handle * dpxio, dpxio_fileio * pfileio, int framenr, sv_fifo_buffer * pbuffer, char * buffer, int buffersize, int xsize, int ysize, int dpxtype, int nbits, int offset, int padding, int timecode)
{
#if 0
  char filename[MAX_PATHNAME];
  void * fp;
