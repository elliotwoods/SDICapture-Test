...
#define VIDEO_FORMAT_ARI        4

#define VIDEO_STEREO_NONE         0
#define VIDEO_STEREO_INTERLEAVED  1
#define VIDEO_STEREO_DUALSTREAM   2
...
typedef struct {
  ...
  dpxio_fileio videoio[2];
  dpxio_fileio audioio;
