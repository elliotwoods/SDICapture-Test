...
char * sv_support_videomode2string(int videomode)
{
  ...
  case SV_MODE_PAL608:                    mode = "PAL608";                break;
  case SV_MODE_PALFF:                     mode = "PALFF";                 break;
  ...
  case SV_MODE_NTSCFF:                    mode = "NTSCFF";                break;
  ...
  case SV_MODE_SONY2K_2048x1556_23sF:     mode = "SONY2K_2048x1556/23sF"; break;
  case SV_MODE_SONY2K_2048x1556_24sF:     mode = "SONY2K_2048x1556/24sF"; break;
  case SV_MODE_SONY2K_2048x1556_25sF:     mode = "SONY2K_2048x1556/25sF"; break;



  case SV_MODE_QUADSDI_3840x2160_23P:     mode = "QUADSDI_3840x2160/23P";  break;
  case SV_MODE_QUADSDI_3840x2160_24P:     mode = "QUADSDI_3840x2160/24P";  break;
  case SV_MODE_QUADSDI_3840x2160_25P:     mode = "QUADSDI_3840x2160/25P";  break;
  case SV_MODE_QUADSDI_4096x2160_23P:     mode = "QUADSDI_4096x2160/23P";  break;
  case SV_MODE_QUADSDI_4096x2160_24P:     mode = "QUADSDI_4096x2160/24P";  break;
  case SV_MODE_QUADSDI_4096x2160_25P:     mode = "QUADSDI_4096x2160/25P";  break;
  ...
  if(offset) {
    ...
    if(!strcmp(tmp[0], "PAL")) {
      ...
      if(!strcmp(tmp[1], "23sF")) {
        ...
        mode = SV_MODE_FILM2K_2048x1080_25sF;
      } else if(!strcmp(tmp[1], "23P")) {
...
char * sv_support_devtype2string(int devtype)
{
  ...
  case SV_DEVTYPE_ATOMIXLT:
    return "Atomix LT";
  case SV_DEVTYPE_ATOMIXHDMI:
    return "Atomix HDMI";
  case SV_DEVTYPE_CINEPLAY:
    return "CinePlay";
  }
