/*
//      DVS C-Library FifoAPI Header File, Copyright (c) 1998-2012 DVS Digital Video Systems GmbH
*/
...
#define SV_FIFO_FLAG_STEREOMODE_A         0x02000000 ///< Obsolete
#define SV_FIFO_FLAG_STEREOMODE_B         0x04000000 ///< Obsolete
#define SV_FIFO_FLAG_STEREO               0x08000000 ///< Enables stereo output offsets in fifo structure.
