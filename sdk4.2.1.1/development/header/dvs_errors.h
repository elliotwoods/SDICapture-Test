/*
 *      DVS C-Library Errors Header File, Copyright (c) 1994-2012 DVS Digital Video Systems GmbH
 *
...
err(SV_ERROR_VOLTAGE_TOOLOW,         203,
"SV_ERROR_VOLTAGE_TOOLOW. Voltage measured is too low.")

err(SV_ERROR_VOLTAGE_TOOHIGH,        204,
"SV_ERROR_VOLTAGE_TOOHIGH. Voltage measured is too high.")
...
"SV_ERROR_DRIVER_HWCHECK. Driver hardware check failed.")
...
err(SV_ERROR_RESOURCENOTAVAILABLE,  223,
"SV_ERROR_RESOURCENOTAVAILABLE. The needed resource for this mode is currently not available.")
...
err(SV_ERROR_JPEG2K_DECODE,         225,
"SV_ERROR_JPEG2K_DECODE. Illegal internal chip state.")

err(SV_ERROR_WRONG_TIME,            226,
"SV_ERROR_WRONG_TIME. Illegal time detected.")

err(SV_ERROR_DIRECT_NULL,                    227,
"SV_ERROR_DIRECT_NULL. Direct API handle is NULL.")

err(SV_ERROR_DIRECT_INVALID,                 228,
"SV_ERROR_DIRECT_INVALID. Direct API handle invalid.")

err(SV_ERROR_DIRECT_BUFFER_INDEX,            229,
"SV_ERROR_DIRECT_BUFFER_INDEX. Wrong buffer index specified in Direct API.")

err(SV_ERROR_DIRECT_BUFFER_ALREADY_BOUND,    230,
"SV_ERROR_DIRECT_BUFFER_ALREADY_BOUND. Direct API buffer was already bound.")

err(SV_ERROR_DIRECT_BUFFER_NOT_BOUND,        231,
"SV_ERROR_DIRECT_BUFFER_NOT_BOUND. Direct API buffer was not correctly bound.")

err(SV_ERROR_DIRECT_BUFFER_SYNC,             232,
"SV_ERROR_DIRECT_BUFFER_SYNC. Synchronization dependencies not met in Direct API.")

err(SV_ERROR_DIRECT_TIMECODE_ALREADY_BOUND,  233,
"SV_ERROR_DIRECT_TIMECODE_ALREADY_BOUND. Direct API timecode was already bound.")

err(SV_ERROR_DIRECT_TIMECODE_NOT_BOUND,      234,
"SV_ERROR_DIRECT_TIMECODE_NOT_BOUND. Direct API timecode was not correctly bound.")

err(SV_ERROR_DIRECT_TEXTURE_INVALID,         235,
"SV_ERROR_DIRECT_TEXTURE_INVALID. Invalid texture in Direct API.")

err(SV_ERROR_DIRECT_OPENED,                  236,
"SV_ERROR_DIRECT_OPENED. This command cannot be done when a Direct API instance is opened.")

err(SV_ERROR_DIRECT_CLOSED,                  237,
"SV_ERROR_DIRECT_CLOSED. This command cannot be done when a Direct API instance is closed.")

err(SV_ERROR_DIRECT_STARTED,                 238,
"SV_ERROR_DIRECT_STARTED. This command cannot be done when a Direct API instance is started.")

err(SV_ERROR_DIRECT_STOPPED,                 239,
"SV_ERROR_DIRECT_STOPPED. This command cannot be done when a Direct API instance is stopped.")

err(SV_ERROR_DIRECT_STORAGEMODE_INVALID,     240,
"SV_ERROR_DIRECT_STORAGEMODE_INVALID. Invalid storage mode in Direct API.")

err(SV_ERROR_DIRECT_CUDA_PTR_INVALID,        241,
"SV_ERROR_DIRECT_CUDA_PTR_INVALID. Invalid CUDA device pointer in Direct API.")

err(SV_ERROR_DIRECT_CUDA_ARRAY_INVALID,      242,
"SV_ERROR_DIRECT_CUDA_ARRAY_INVALID. Invalid CUDA array in Direct API.")

err(SV_ERROR_DIRECT_DIRECT3D_INVALID,        243,
"SV_ERROR_DIRECT_DIRECT3D_INVALID. Invalid Direct3D object in Direct API.")

err(SV_ERROR_WRONGMODE_ROUTING,              244,
"SV_ERROR_WRONGMODE_ROUTING. Operation not possible for current video routing setting.")

err(SV_ERROR_WRONGMODE_MULTICHANNEL,         245,
"SV_ERROR_WRONGMODE_MULTICHANNEL. Operation not possible for current multichannel setting.")

err(SV_ERROR_DIRECT_ANC_ALREADY_BOUND,       246,
"SV_ERROR_DIRECT_ANC_ALREADY_BOUND. Direct API anc callback was already bound.")
