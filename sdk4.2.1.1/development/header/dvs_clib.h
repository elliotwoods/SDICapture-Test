/*
//      DVS C-Library Header File, Copyright (c) 1994-2012 DVS Digital Video Systems GmbH
//
...
#define SV_DEVTYPE_ATOMIXHDMI          26
#define SV_DEVTYPE_CINEPLAY            27
...
#define SV_LICENCEBIT_CLIPSTER_WORKFLOWDAILIES        117
#define SV_LICENCEBIT_CLIPSTER_WORKFLOWSTEREOENHANCED 118
#define SV_LICENCEBIT_CLIPSTER_RESERVED1              119
#define SV_LICENCEBIT_CLIPSTER_SOFTWARE4x0            120
#define SV_LICENCEBIT_CLIPSTER_VENICE2x0              121
#define SV_LICENCEBIT_CLIPSTER_STAN                   122
#define SV_LICENCEBIT_CLIPSTER_JPEG2000_SW_SPEEDPACK  123
#define SV_LICENCEBIT_CLIPSTER_IMF_WIZARD             124
...
#define SV_MODE_SMPTE274_30I      0x22  /*              1920x1080 30.00hz Interlaced      */
...
#define SV_MODE_SONY2K_2048x1556_23sF   (0x4b | SV_MODE_FLAG_DROPFRAME)
#define SV_MODE_SONY2K_2048x1556_24sF   (0x4b)
#define SV_MODE_SONY2K_2048x1556_25sF   (0x4c)
...
#define SV_MODE_QUADDVI_3840x2160_47P     (0x87 | SV_MODE_FLAG_DROPFRAME)
...
#define SV_MODE_FILM2K_2048x1768_24P      (0xb1)

#define SV_MODE_QUADSDI_4096x2160_25P     (0xb2)
#define SV_MODE_QUADSDI_3840x2160_25P     (0xb3)

#define SV_MODE_QUADSDI_4096x1716_24P     (0xb4)
#define SV_MODE_QUADSDI_3996x2160_24P     (0xb5)

//#define SV_MODE_UNUSED                  0xb6

#define SV_MODE_FILM4K_4096x2304_24P      (0xb7)
#define SV_MODE_FILM4K_4096x2304_24sF     (0xb8)

//#define SV_MODE_RESERVED                (0xb9)
//#define SV_MODE_RESERVED                (0xba)
//#define SV_MODE_RESERVED                (0xbb)

#define SV_MODE_HDMI_3840x2160_23P        (0xbc | SV_MODE_FLAG_DROPFRAME)
#define SV_MODE_HDMI_3840x2160_24P        (0xbc)
#define SV_MODE_HDMI_3840x2160_25P        (0xbd)
#define SV_MODE_HDMI_3840x2160_29P        (0xbe | SV_MODE_FLAG_DROPFRAME)
#define SV_MODE_HDMI_3840x2160_30P        (0xbe)

#define SV_MODE_HDMI_4096x2160_23P        (0xbf | SV_MODE_FLAG_DROPFRAME)
#define SV_MODE_HDMI_4096x2160_24P        (0xbf)

#define SV_MODE_FILM2K_2048x1080_29sF     (0xc0 | SV_MODE_FLAG_DROPFRAME)
#define SV_MODE_FILM2K_2048x1080_30sF     (0xc0)

#define SV_MODE_MAX                       0xc1
...
#define SV_OPTION_ASSIGN_LTC                188  /* OBSOLETE */
#define SV_OPTION_ASSIGN_LTCA               188
...
#define SV_OPTION_AUDIONOFADING             217
#define SV_OPTION_AUDIOAESSOURCE            218
#define SV_OPTION_FIFO_JPEG2000             219
#define SV_OPTION_HDMIOUTPUT                220
...
#define SV_DVI_OUTPUT_DVI8              0x0000
#define SV_DVI_OUTPUT_DVI12             0x0001
#define SV_DVI_OUTPUT_DVI16             0x0002
#define SV_DVI_OUTPUT_MASK              0x000f
#define SV_DVI_STEREO_ENABLE            0x0010
...
#define SV_MAINOUTPUT_DVI               0x0001  /* On cards that can not do both dvi/sdi make dvi the main output */
#define SV_MAINOUTPUT_HDMI              0x0002  /* On cards that can not do both hdmi/sdi make hdmi the main output */
...
#define SV_HDMIOUTPUT_DEFAULT               0x00000000
#define SV_HDMIOUTPUT_3DSOURCE              0x00010000
#define SV_HDMIOUTPUT_3DSOURCE_LEFTRIGHT    0x00010001
#define SV_HDMIOUTPUT_3DSOURCE_TOPBOTTOM    0x00010002
#define SV_HDMIOUTPUT_3DSOURCE_INTERLACE    0x00010003
#define SV_HDMIOUTPUT_3DSTREAM              0x00020000
#define SV_HDMIOUTPUT_3DSTREAM_FRAMEPACKING 0x00020001
#define SV_HDMIOUTPUT_MASK                  0x00ff0000
...
#define SV_TRACE_ERROR                  0x0001
#define SV_TRACE_SETUP                  0x0002
#define SV_TRACE_STORAGE                0x0004
#define SV_TRACE_FIFOAPI                0x0008
#define SV_TRACE_CAPTURE                0x0010
#define SV_TRACE_VTRCONTROL             0x0020
#define SV_TRACE_TCCHECK                0x0040
#define SV_TRACE_RENDER                 0x0080
#define SV_TRACE_DIRECTAPI              0x0100
...
#define SV_AUDIOAESROUTING_8_0          4
#define SV_AUDIOAESROUTING_0_8          5

#define SV_AUDIOAESSOURCE_DEFAULT       0
#define SV_AUDIOAESSOURCE_BACK          1
#define SV_AUDIOAESSOURCE_FRONT         2
...
#define SV_QUERY_LTCAVAILABLE           190
...
#define SV_MIXER_MODE_STEREO_LUMADIFF     43
#define SV_MIXER_MODE_STEREO_CHECKERBOARD 44
...
typedef union {
  struct {
    ...
    int flags;                ///< Matrix Flags. At the moment only SV_MATRIX_FLAG_FORCEMATRIX is supported.
    int matrixid;             ///< Matrix position within pipeline. Future purpose set to 0.
...
#define SV_RASTEROPTION_RENDERONLY        0x00000800
/* SV_RASTEROPTION_RESERVED               0x00001000 */
#define SV_RASTEROPTION_HDMIRASTER        0x00002000
...
#define SV_OPENPROGRAM_STAN               0x0000000e
...
typedef struct {
  ...
  int buffertype;   ///! Version:2 - frame=0,field1-1,field2-2,debug-3
  ...
  int eyemode;      ///! Version:3 - SV_EYEMODE_xxx
  int audioformat;  ///! Version:4 - 1632 -> 16 channels, 32 bits (only if flag SV_CAPTURE_FLAG_AUDIO is set)
  int audiooffset;  ///! Version:4 - Offset to first audio sample in buffer (only if flag SV_CAPTURE_FLAG_AUDIO is set)
  int audiosize;    ///! Version:4 - Size of audio captured (only if flag SV_CAPTURE_FLAG_AUDIO is set)
  int usercookiehigh; ///! Version:5 - Avus buffermagic to synchronize capture buffers for proxy creation
  int usercookielow;  ///! Version:5 - Avus buffermagic to synchronize capture buffers for proxy creation
  int proxyid;      ///! Version:6 - Internal buffer-id, can be used to detect dropped frames
  int pad[7];
} sv_capturebuffer;
#endif
...
#define SV_JP2K_MCTRANFORM_DEFAULT            0
#define SV_JP2K_MCTRANFORM_NONE               0
#define SV_JP2K_MCTRANFORM_ICT                1
#define SV_JP2K_MCTRANFORM_RCT                2
...
#define SV_DECOMPRESSION_DCI4K_HALF   0x00000001
...
export int  sv_debugoption_clear(
#ifdef __PROTOTYPES__
        sv_handle * sv
#endif
);
